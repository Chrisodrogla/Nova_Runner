...
for website in proxy_links:
    ...
    try:
        proxy_title_check = driver.find_element("xpath",
                                          """//*[@id="get-email"]/div/main/div[3]/div[1]/h2|//div[@class="row single-rankings-title"]/div/h2""")
        guest_satisfaction_check = driver.find_element("xpath",
                                                 """(//div[@class="single-value"]/b|//*[@id="metric-cards-grid"]/div[10]/div/div[2]/b)""")
        reviews_count_check = driver.find_element("xpath",
                                            """(//div[@class="single-value"]/b)[2]|(//div[@class="single-value"]/b)""")
    except:
        continue
    ...
    guest_satisfaction = driver.find_element("xpath", """(//div[@class="single-value"]/b|//*[@id="metric-cards-grid"]/div[10]/div/div[2]/b)""").get_attribute("innerText")
